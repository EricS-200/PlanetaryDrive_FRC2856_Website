      ...
      <div>
        ...
        <p>
          ...
          <Button variant="link" className="dark font-normal text-lg p-0">
            <Link href="https://newtonsattic.com/" target="_blank" className={"border-b-2 hover:border-0 border-blue-400"}>
              Newton's Attic
            </Link>
          </Button>
        </p>
        <p>
          ...
          <span className={"border-b-2 hover:border-black border-blue-400"}>
          planetarydrive2856@gmail.com
          </span>
        </p>
      </div>
      <div>
        <h2><span className={"border-b-2 hover:border-black border-blue-400"}>Pages</span></h2>
        <ul>
          {pages.map((link) => (
            <li>
              <Link href={link.page} key={link.name} className={"border-b-2 hover:border-black border-blue-400"}>
                {link.name}
              </Link>
            </li>
          ))}
