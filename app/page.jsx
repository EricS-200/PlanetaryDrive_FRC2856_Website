...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="flex flex-col lg:flex-row justify-center items-center mt-16 aos-init aos-animate" data-aos={"fade-left"} data-aos-duration={1000} data-aos-offset={400} data-aos-delay={350}>
        <Image
