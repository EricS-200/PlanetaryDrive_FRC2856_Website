...
import mainBanner from "/public/sponsors/sponsors-banner.jpg";
...
export default function Sponsors() {
  ...
  return (
    <main className="flex flex-col items-center">
      <ParallaxBanner
        src={mainBanner}
        className="h-[50vh] xl:h-[45vh]"
        speed={0.5}
      />
      <section className="bg-zinc-950 flex flex-col items-center justify-center pt-5 pb-5 min-h-[50vh] w-full">
        <div className="space-y-5 w-[90vw] lg:w-2/3 2xl:w-1/2 flex flex-col items-center">
          ...
          <p className="text-lg text-center">
            ...
            to build a robot meeting the specifications of that year's event,
            which by itself can cost thousands of dollars. Going to the
          ...
          <p className="text-lg text-center">
            ...
            role in enabling our team's success, and we deeply appreciate their
            support. If you are interested in sponsoring us, or helping out in
            any way, please feel free to{" "}
            <Link
              href="/contact"
      ...
      <section
        ref={sponsorLogos}
        className="2xl:w-1/2 xl:w-2/3 lg:w-3/4 md:w-3/4 w-[85%] flex flex-col items-center mt-12 md:mt-0"
      >
        <SponsorLogos />
      </section>
    </main>
